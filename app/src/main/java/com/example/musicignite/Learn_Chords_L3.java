...
public class Learn_Chords_L3 extends AppCompatActivity {
    ...
    int[] playerViewIds = {
            ...
            R.id.vid13, R.id.vid14, R.id.vid15
    };
    int[] playButtonIds = {
            ...
            R.id.playButton13, R.id.playButton14, R.id.playButton15
    };
    int[] thumbnailIds = {
            ...
            R.id.thumb13, R.id.thumb14, R.id.thumb15
    };
    int[] rawIds = {
            R.raw.chords_l3_vid01, R.raw.chords_l3_vid02, R.raw.chords_l3_vid03, R.raw.chords_l3_vid04, R.raw.chords_l3_vid05,
            R.raw.chords_l3_vid06, R.raw.chords_l3_vid07, R.raw.chords_l3_vid08, R.raw.chords_l3_vid09, R.raw.chords_l3_vid10,
            R.raw.chords_l3_vid11, R.raw.chords_l3_vid12, R.raw.chords_l3_vid13, R.raw.chords_l3_vid14, R.raw.chords_l3_vid15
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_chords_l3);
        ...
        String[] htmlTexts = {
                "• A <b>seventh chord</b> is the combination of a triad and an interval of a seventh.",
                "• A major triad and a minor seventh combine to form a <b>dominant seventh chord</b>.",
                "• A major triad and a major seventh combine to form a <b>major seventh chord</b>.",
                "• A minor triad and a minor seventh combine to form a <b>minor seventh chord</b> (m7).",
                "• A diminished triad and a minor seventh combine to form a <b>half-diminished seventh chord</b>.",
                "• Finally, a diminished triad and a diminished seventh combine to form a <b>diminished seventh chord<b> (or <b>fully diminished seventh chord</b>)."
        };
