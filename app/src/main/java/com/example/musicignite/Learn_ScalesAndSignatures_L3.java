...
public class Learn_ScalesAndSignatures_L3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_scales_l3);
        ...
        videoUris.add(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.scales_lesson3_vid1));
        videoUris.add(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.scales_lesson3_vid2));
    }
