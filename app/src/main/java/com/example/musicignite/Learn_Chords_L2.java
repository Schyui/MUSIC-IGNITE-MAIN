...
public class Learn_Chords_L2 extends AppCompatActivity {
    ...
    int[] playerViewIds = {
            R.id.vid1, R.id.vid2, R.id.vid3, R.id.vid4
    };
    int[] playButtonIds = {
            R.id.playButton1, R.id.playButton2, R.id.playButton3, R.id.playButton4
    };
    int[] thumbnailIds = {
            R.id.thumb1, R.id.thumb2, R.id.thumb3, R.id.thumb4
    };
    int[] rawIds = {
            R.raw.chords_l3_vid01, R.raw.chords_l3_vid02, R.raw.chords_l3_vid03, R.raw.chords_l3_vid04
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_learn_chords_l2);
        ...
        String[] htmlTexts = {
                "• The lowest note, called the <b>bass note</b>, determines the name of the inversion.",
                "• When the lowest note is the root of the chord, the triad is in <b>root position.</b>",
                "• This is called <b>first inversion.</b>",
                "• This is called <b>second inversion.</b>"
        };
